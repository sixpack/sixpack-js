...
export default class Session {
  constructor({ base_url, timeout, cookie, extra_params, client_id, ip_address, user_agent, ignore_alternates_warning }) {
  ...
  buildParticipateParams = ({ trafficFraction, experimentName, alternatives }) => {
    const params = {
      ...this.extra_params,
    ...
    if (trafficFraction !== null && !isNaN(trafficFraction)) {
